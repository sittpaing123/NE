...
async def ch1_give_filter(bot: Bot, message: types.Message):
    ...
    if re.findall("((^\/|^,|^!|^\.|^[\U0001F600-\U000E007F\u1000-\u109F\uAA60-\uAA7F()\d]).*)", message.text):  
        return
...
<a href='https://t.me/+6lHs-byrjxczY2U1'>©️ 𝗙𝗜𝗟𝗘 𝗦𝗧𝗢𝗥𝗘 𝗖𝗛𝗔𝗡𝗡𝗘𝗟</a><a href='https://t.me/+X7DNvf9iCy5jOGJl'>©️ 𝗝𝗢𝗜𝗡 𝗚𝗥𝗢𝗨𝗣</a>"""
